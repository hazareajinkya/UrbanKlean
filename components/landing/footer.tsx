...
const socialLinks = [
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/profile.php?id=61583111064272",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "YouTube",
    href: "https://www.youtube.com/@MagicalCX",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
export const Footer = () => {
  return (
    <footer className="section-container bg-background border overflow-hidden dark relative ">
      <div
        className={`section-content-padding py-10 sm:py-12 lg:py-16 border-b border-border relative z-10`}
      >
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-8 sm:gap-10 lg:gap-12">
          ...
          {Object.values(footerLinks).map((section) => (
            <div key={section.title} className="col-span-1">
              ...
              <ul className="space-y-2 sm:space-y-3 text-sm sm:text-sm text-muted-foreground">

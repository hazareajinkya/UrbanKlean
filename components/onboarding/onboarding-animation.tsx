        ...
        <div className="bg-zinc-900/80 backdrop-blur-2xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden relative z-10 ring-1 ring-white/5 flex flex-col min-h-[500px]">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-white/5 bg-white/5 relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 relative z-10">
              <span className="text-sm font-bold tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 via-purple-300 to-indigo-300 animate-shimmer bg-[length:200%_100%]">
                MagicalCX
              </span>
            </div>
            <div className="flex gap-1.5 opacity-60 relative z-10">
  ...
  return (
    <AnimatePresence>
      {visible && (
        ...
        >
          <div className="bg-transparent px-2 py-1 flex items-center gap-1.5 opacity-50">

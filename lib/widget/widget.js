(function () {
  ...
  function getWidgetConfig() {
    ...
    if (window.SUPERCX_AGENT_CONFIG) {
      console.log(
        "SuperCX Widget: Using injected config",
    ...
    console.warn("SuperCX Widget: No configuration found, using defaults");
    console.warn(
  ...
  function createWidgetButton() {
    ...
    console.log("SuperCX Widget: Bot icon value:", botIcon);
    console.log("SuperCX Widget: Bot icon type:", typeof botIcon);
    console.log(
      "SuperCX Widget: Bot icon starts with http:",
    ...
    if (
      ...
      // It's an image URL
      console.log("SuperCX Widget: Creating image element for bot icon");
      ...
      img.onerror = function () {
        console.error("SuperCX Widget: Image failed to load:", botIcon);
        button.innerHTML = "💬";
      };

      img.onload = function () {
        console.log("SuperCX Widget: Image loaded successfully:", botIcon);
      };
      ...
      console.log("SuperCX Widget: Using text/emoji for bot icon:", botIcon);
  ...
  function createChatIframe() {
    const config = getWidgetConfig();
    if (!config.agentId) {
      console.error("SuperCX Widget: No agent ID provided");
      return null;
    }
    ...
    iframe.addEventListener("load", function () {
      console.log("SuperCX Widget: Chat iframe loaded");
    });
  ...
  function handleMessage(event) {
    if (event.data.type === "SUPERCX_WIDGET_CLOSE") {
      ...
      console.log("SuperCX Widget chat interface ready");
    }
  }

(function () {
  ...
  function getWidgetConfig() {
    ...
    if (window.SUPERCX_AGENT_CONFIG) {
      console.log(
        "Humanly Clear Widget: Using injected config",
    ...
    console.warn(
      "Humanly Clear Widget: No configuration found, using defaults"
    );
    console.warn(
  ...
  function createWidgetButton() {
    ...
    console.log("Humanly Clear Widget: Bot icon value:", botIcon);
    console.log("Humanly Clear Widget: Bot icon type:", typeof botIcon);
    console.log(
      "Humanly Clear Widget: Bot icon starts with http:",
    ...
    if (
      ...
      // It's an image URL
      console.log("Humanly Clear Widget: Creating image element for bot icon");
      ...
      img.onerror = function () {
        console.error("Humanly Clear Widget: Image failed to load:", botIcon);
        button.innerHTML = "💬";
      };

      img.onload = function () {
        console.log(
          "Humanly Clear Widget: Image loaded successfully:",
          botIcon
        );
      };
      ...
      console.log(
        "Humanly Clear Widget: Using text/emoji for bot icon:",
        botIcon
      );
  ...
  function createChatIframe() {
    const config = getWidgetConfig();
    if (!config.agentId) {
      console.error("Humanly Clear Widget: No agent ID provided");
      return null;
    }
    ...
    iframe.addEventListener("load", function () {
      console.log("Humanly Clear Widget: Chat iframe loaded");
    });
  ...
  function handleMessage(event) {
    if (event.data.type === "SUPERCX_WIDGET_CLOSE") {
      ...
      console.log("Humanly Clear Widget chat interface ready");
    }
  }

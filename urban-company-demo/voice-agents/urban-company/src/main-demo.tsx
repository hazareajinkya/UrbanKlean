        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <div className="flex bg-white/[0.08] rounded-full p-0.5 mr-2">
              <span className="px-3 py-1 rounded-full text-xs font-medium bg-white text-black">Voice Demo</span>
              ...
              {(["booking","out_of_service","feedback","language_switch"] as const).map((type, i) => (
                <button key={type}
                  ...
                  className={cn("px-3 py-1 rounded-full text-xs font-medium transition-all flex items-center gap-1",
                    demoType === type ? "bg-white text-black" : "text-white/50 hover:text-white")}>
            ...
            <span className={cn("px-3 py-1 rounded-full text-xs font-medium ml-2",
              isVoiceConnected ? "bg-white text-black" : "bg-white/[0.08] text-white/50")}>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-4 max-w-md mx-auto">
              <div className="flex items-start gap-3">
                <div className="size-12 rounded-full bg-black flex items-center justify-center shadow-sm shrink-0">
            ...
            <div className="aspect-square max-w-[340px] mx-auto relative">
              ...
              <div className="absolute bottom-4 left-0 right-0 text-center">
                <span className="inline-block px-4 py-2 bg-black/70 backdrop-blur-sm rounded-full text-sm text-white">
            ...
            <div className="space-y-4">
              {isVoiceConnected || isSimulating ? (
                <div className="flex gap-3 justify-center">
                  ...
                  <Button size="lg" className="rounded-full px-6 bg-black hover:bg-gray-900 text-white" onClick={handleEndVoice}>
                ...
                <div className="flex justify-center">
                  <Button
                    className="w-full max-w-sm rounded-full bg-black hover:bg-gray-900 text-white font-medium h-12 text-base"
              ...
              <div className="p-5 min-h-[480px]">
                ...
                {currentStep === "greeting" && (
                  <div className="space-y-5 animate-in fade-in duration-500">
                    <div className="text-center py-8">
                      <div className="size-16 rounded-xl bg-black flex items-center justify-center mx-auto mb-4 shadow-lg shadow-black/20">
                      ...
                      {SERVICES.map((service) => (
                        <button key={service.id} onClick={() => setSelectedService(service)}
                          className={cn("p-4 rounded-2xl border transition-all text-left",
                            selectedService?.id === service.id ? "border-black bg-gray-50 shadow-sm" : "border-gray-200 hover:border-gray-400")}>
                ...
                {currentStep === "quantity_selection" && selectedService && (
                  <div className="space-y-5 animate-in fade-in duration-500">
                    ...
                    <div className="bg-black rounded-2xl p-4 text-center mt-4">
                      <p className="text-white/60 text-xs uppercase tracking-wide">Estimated Total</p>
                      <p className="text-2xl font-bold text-white">₹{calculateTotal().total}</p>
                      <p className="text-white/50 text-xs">(incl. 18% GST)</p>
                    </div>
                  </div>
                )}
                      ...
                      {PERIODS.map((p) => {
                        ...
                        return (
                          <button key={p.id} onClick={() => setSelectedPeriod(p.id)}
                            ...
                            <Icon className={cn("size-7", isActive ? "text-black" : "text-gray-400")} />
                      ...
                      {TIME_SLOTS.filter(s => !selectedPeriod || s.period === selectedPeriod).map((slot, i) => (
                        <button key={i} disabled={!slot.available} onClick={() => setSelectedSlot(slot)}
                          className={cn("p-3 rounded-xl border transition-all text-left",
                            ...
                            : selectedSlot === slot ? "border-black bg-gray-50"
                ...
                {currentStep === "language_intro" && (
                  <div className="space-y-5 animate-in fade-in duration-500">
                    <div className="text-center py-2">
                      <div className="size-16 rounded-xl bg-black flex items-center justify-center mx-auto mb-3 shadow-lg shadow-black/20">
                    ...
                    <div className="bg-gray-50 rounded-2xl p-4 border border-gray-200">
                      ...
                      <div className="flex items-center gap-3">
                        <div className="size-12 rounded-full bg-white border-2 border-black flex items-center justify-center font-bold text-black">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {Object.values(LANGUAGES).map((lang) => (
                        <div key={lang.code} className={cn("p-3 rounded-xl border text-center transition-all",
                          activeLanguage === lang.code ? "border-black bg-gray-50 scale-105" : "border-gray-200 opacity-60")}>
                ...
                {currentStep === "language_switching" && (
                  <div className="space-y-5 animate-in fade-in duration-500">
                    ...
                    <div className="bg-gray-50 rounded-2xl p-5 text-center border border-gray-200">
                      ...
                      <div className="size-20 rounded-xl bg-black mx-auto flex items-center justify-center mb-3 shadow-lg shadow-black/20 transition-all duration-500">
                          ...
                          {languageHistory.map((lc, i) => (
                            <div key={`${lc}-${i}`} className="flex items-center gap-2">
                              <span className={cn("px-3 py-1.5 rounded-full text-xs font-medium border",
                                i === languageHistory.length - 1 ? "bg-black text-white border-black" : "bg-gray-100 text-gray-700 border-gray-200")}>
                                {LANGUAGES[lc].label}
                              </span>
                  ...
                  <div className="space-y-5 animate-in fade-in duration-500">
                    ...
                    <div className="bg-gray-50 rounded-2xl p-4 border border-gray-200">
                      ...
                      <div className="flex items-center gap-3 mb-4">
                        <div className="size-10 rounded-full bg-black flex items-center justify-center text-white font-bold">
                      ...
                      <div className="flex items-center justify-between border-t border-gray-200 pt-3">
                        ...
                        <span className="px-3 py-1 rounded-full text-sm font-medium bg-black text-white flex items-center gap-1.5">
                ...
                {currentStep === "feedback_complete" && (
                  <div className="space-y-5 animate-in fade-in duration-500 text-center py-4">
                    ...
                    <div className="bg-black rounded-2xl p-4">
                      ...
                      <p className="text-white/60 text-sm">For your next booking</p>
                    </div>
                  </div>
                )}
              </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-4">
              ...
              {customerName ? (
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <div className="size-10 rounded-full bg-black flex items-center justify-center text-white font-bold shadow-sm">
                      {customerName[0]}
                    </div>
                    <div>

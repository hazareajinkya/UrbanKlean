...
const SIGNAL_META: Record<SignalSource, {
  ...
  pattern: { label: "Booking Pattern", icon: RefreshCw, color: "text-purple-500", bg: "bg-purple-50" },
...
const SIGNAL_TEMPLATES: Omit<Signal, "id" | "timestamp">[] = [
  {
    ...
    suggestedService: "Living Room Deep Cleaning",
    estimatedValue: 1500,
  },
  {
    source: "mygate",
    ...
    suggestedService: "Quick Sevak (Daily Cleaning)",
    estimatedValue: 800,
  },
  {
    source: "blinkit",
    ...
    suggestedService: "Fridge & Microwave Deep Clean",
    estimatedValue: 1200,
  },
  {
    source: "pattern",
    ...
    trigger: "Monthly bathroom cleaning due",
    detail: "Last 3 months: 1st of every month · Today is the 1st",
    suggestedService: "Bathroom Cleaning · 2 units",
    estimatedValue: 1180,
  },
  {
    source: "calendar",
    ...
    suggestedService: "Full Home Cleaning Package",
    estimatedValue: 2950,
  },
  {
    source: "zomato",
    ...
    trigger: "Weekend party detected",
    detail: "12 plates ordered · 4 cocktails · Sat 9 PM",
    suggestedService: "Post-Party Deep Cleaning",
    estimatedValue: 2200,
  },
  {
    source: "mygate",
  ...
  },
  {
    ...
    trigger: "Repeat AC service due",
    detail: "Last booked April · seasonal trigger",
    suggestedService: "AC Deep Cleaning · 3 units",
    estimatedValue: 1497,
  },
];

const PITCHES: Record<SignalSource, (s: Signal) => string> = {
  zomato: (s) => `Hi ${s.customerName.split(" ")[0]}! Looks like you had a busy weekend with friends. Want me to book a ${s.suggestedService.toLowerCase()} for tomorrow morning? As a Gold member you get 15% off.`,
  blinkit: (s) => `Hi ${s.customerName.split(" ")[0]}! Noticed you stocked up on non-veg last week. Should I book a ${s.suggestedService.toLowerCase()} for you this weekend?`,
  mygate: (s) => `Hi ${s.customerName.split(" ")[0]}! Saw your maid hasn't been by in a few days. Want me to send a Quick Sevak today? Same time as usual?`,
  pattern: (s) => `Hi ${s.customerName.split(" ")[0]}! Your monthly cleaning is due. Booking the same 2 bathrooms at 11 AM Sunday with your loyalty discount applied. Just say yes!`,
  calendar: (s) => `Hi ${s.customerName.split(" ")[0]}! Big day tomorrow! Want me to book a full home cleaning today so everything sparkles for the celebration?`,
};
...
const REPLIES: { positive: string[]; negative: string[] } = {
  ...
  negative: [
    ...
    "Already booked elsewhere, thanks.",
    "I'll think about it.",
  ],
};
...
export default function TriggersPage() {
  ...
  // Stream signals every few seconds
  useEffect(() => {
    if (!isLive) return;
    ...
    const emitSignal = () => {
      ...
      // Trigger an outbound call after a delay
      setTimeout(() => {
        ...
        // Resolve the call after a few seconds
        setTimeout(() => {
          ...
          if (willConvert) {
            setStats((prev) => ({
              ...
              revenue: prev.revenue + signal.estimatedValue,
            }));
          }
        }, 3500);
      }, 1200);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between gap-4 flex-wrap">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-white/80">Smart Triggers · Proactive AI</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button
              ...
              className={cn(
                ...
                isLive ? "bg-[#facc15] text-[#6b21a8]" : "bg-white/10 text-white/70 hover:text-white"
              )}
            >
              <span className={cn("size-1.5 rounded-full", isLive ? "bg-[#6b21a8] animate-pulse" : "bg-white/50")} />
              {isLive ? "Live" : "Paused"}
            </button>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto p-6 lg:p-10 space-y-6">
        ...
        <div className="bg-white rounded-3xl shadow-sm p-6 flex items-start justify-between gap-6 flex-wrap">
          <div className="max-w-2xl">
            <div className="flex items-center gap-2 mb-2">
              <Sparkles className="size-5 text-[#facc15]" />
              <h2 className="text-xl font-semibold text-gray-800">Be part of your customer&apos;s family</h2>
            </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <section className="bg-white rounded-3xl shadow-sm overflow-hidden">
            <div className="p-5 border-b border-gray-100 flex items-center justify-between">
              <div>
                <h3 className="text-base font-semibold text-gray-800">Customer Signals</h3>
            ...
            <div className="p-4 space-y-3 min-h-[420px]">
              ...
              {signals.map((signal) => {
                ...
                return (
                  <div
                    key={signal.id}
                    className="rounded-2xl border border-gray-100 p-3 hover:border-purple-200 transition-all animate-in fade-in slide-in-from-top-2 duration-500"
                  >
          ...
          <section className="bg-white rounded-3xl shadow-sm overflow-hidden">
            <div className="p-5 border-b border-gray-100">
              <h3 className="text-base font-semibold text-gray-800">Trigger Rules</h3>
            ...
            <div className="p-4 space-y-3">
              <RuleCard
                ...
                color="text-red-500"
                bg="bg-red-50"
                title="Late-Night Order Pattern"
                description="If 3+ Zomato orders after 11 PM in a week → suggest deep cleaning"
              ...
              <RuleCard
                ...
                bg="bg-blue-50"
                title="Maid Absence"
                description="If maid not entered society for 3+ days via MyGate → offer Quick Sevak"
              ...
              <RuleCard
                ...
                bg="bg-yellow-50"
                title="Bulk Grocery Detection"
                description="If non-veg + groceries ordered → suggest fridge cleaning in 5 days"
              ...
              <RuleCard
                ...
                bg="bg-purple-50"
                title="Repeat Booking Pattern"
                description="If monthly service due based on history → auto-suggest with loyalty discount"
              ...
              <RuleCard
                ...
                description="Birthday/anniversary detected → suggest full home cleaning"
                fired={signals.filter((s) => s.source === "calendar").length}
              />
              <button className="w-full p-3 rounded-2xl border-2 border-dashed border-gray-200 text-gray-400 hover:border-purple-200 hover:text-[#6b21a8] transition-all text-sm flex items-center justify-center gap-2">
          ...
          <section className="bg-white rounded-3xl shadow-sm overflow-hidden">
            <div className="p-5 border-b border-gray-100 flex items-center justify-between">
              <div>
                <h3 className="text-base font-semibold text-gray-800">Outbound AI Calls</h3>
        ...
        {/* Footer info strip */}
        <div className="bg-gradient-to-r from-[#6b21a8] to-[#7e22ce] rounded-3xl p-6 text-white flex items-center justify-between gap-6 flex-wrap">
          <div className="max-w-xl">
            <h3 className="text-lg font-semibold mb-1">Why this matters</h3>
            <p className="text-sm text-white/80">
              Most service businesses lose leads to peak-hour congestion or off-hours. Smart Triggers turn passive customers into active bookings — without a single human dial.
            </p>
          </div>
          <div className="flex gap-2 flex-wrap">
            <span className="px-3 py-1.5 rounded-full bg-white/10 text-xs flex items-center gap-1.5">
              <Clock className="size-3" /> Runs 24×7
            </span>
            <span className="px-3 py-1.5 rounded-full bg-white/10 text-xs flex items-center gap-1.5">
              <PartyPopper className="size-3" /> No human required
            </span>
            <span className="px-3 py-1.5 rounded-full bg-[#facc15] text-[#6b21a8] text-xs font-semibold flex items-center gap-1.5">
...
const StatCard = ({
  ...
  <div className="rounded-2xl border border-gray-100 p-3">
    ...
    <p className="text-xl font-semibold text-gray-800 tabular-nums">{value}</p>
    ...
    <div className="flex items-start gap-3">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between gap-2 mb-1">
          ...
          {fired > 0 && (
            <span className="text-xs px-1.5 py-0.5 rounded-md bg-purple-50 text-[#6b21a8] font-medium tabular-nums">
              {fired}
            </span>
          )}
        </div>
...
const CallCard = ({ call }: { call: CallEvent }) => {
  ...
  return (
    <div className="rounded-2xl border border-gray-100 p-3 animate-in fade-in slide-in-from-top-2 duration-500">
      <div className="flex items-start gap-3 mb-2">
        <div
          className={cn(
            ...
            isCalling && "bg-purple-50",
            isConverted && "bg-green-50",
            isDeclined && "bg-gray-100"
          )}
        >
          {isCalling && <PhoneIncoming className="size-4 text-[#6b21a8] animate-pulse" />}
          ...
          <div className="flex items-center justify-between mb-0.5">
            ...
            <span
              className={cn(
                ...
                isCalling && "bg-purple-100 text-[#6b21a8]",
      ...
      <div className="text-xs text-gray-600 bg-purple-50 rounded-xl p-2 italic">
      ...
      {isConverted && (
        <div className="mt-2 flex items-center justify-between text-xs">
          ...
          <span className="font-semibold text-green-600">+₹{call.signal.estimatedValue}</span>
        </div>
      )}
    </div>
  );
